...
def train(args, config, train_data, valid_data):
    ...
    model = RobertaM2Transfer(ckpt_path, 4, freeze=args.freeze)
    model.cuda()
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        ...
        for i in range(5):
            ...
            args.save_path = os.path.join(save_path, 'Ses{}'.format(i))
        ...
        pickle.dump(report, open(os.path.join(args.save_path, 'iemocap_report.pkl'),'wb'))
