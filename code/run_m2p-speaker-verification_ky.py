...
def train(args, config, train_data):
    ...
    model = KYRobertaM2Transfer(args.ckpt_path, args.speaker_nums, freeze=args.freeze, use_pretrained=args.use_pretrained)
    model.cuda()
...
if __name__ == '__main__':
    ...
    parser_train.add_argument("--use_pretrained", type=bool, default=False, help="whether use pre-trained model")
